...
<html lang="en">
  ...
  <body>
    <!-- Navbar start -->
    <nav class="navbar">
      <a href="#" class="navbar-logo">Gunawan <span>CoffeeShop.</span></a>
    ...
    <section class="hero" id="home">
      <main class="content">
        ...
        <p>Rasakan kenikmatan hidup dengan segelas kopi berkualitas.</p>
...
<!-- Alhamdulillah tinggal implementasi Cloud Computing -->
